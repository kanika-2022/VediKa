    ...
    >
          ...
          >
            <span v-if="item.link">
              <fdk-link :link="item.link" target="_blank" :title="item.title">
                <img width="25px" alt="social.title" :src="item.icon" />
              </fdk-link>
            </span>
          </li>
        </ul>
      ...
      >
        <div class="left bottom-menu">
          <div class="left__navigation"></div>
        </div>
        <div class="center-cont">
          <ul class="l1-navigation-list">
            <li
              class="l1-navigation-list__item mr-5"
              v-for="(nav, index) in context.navigation.slice(
                0,
                context.navigation.length / 2
              )"
              :key="index"
            >
              <div class="l1-navigation">
                        ...
                        <div
                          ...
                          >
                            <div
                                ...
                                v-for="(subsubnav, index) in subnav.sub_navigation"
                                :key="index"
                                >
                              <fdk-link :link="subsubnav.link">
                                <p>{{ subsubnav.display }}</p>
                              </fdk-link>
                            </div>
                          </div>
                        </div>
